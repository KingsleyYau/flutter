...
class LSSendInviteMsgTask : public ILSLiveChatTask
{
public:
	LSSendInviteMsgTask(void);
	virtual ~LSSendInviteMsgTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, const string& message, const string& nickName);
...
private:
	...
	string			m_message;	// 邀请语
    string          m_userName; // 对方名字
